...
public class WebcamTexture_Com : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        init = 0f;
        time = 60f;
        before_url = "C://Users//light1//VWphoto//before//";
        after_url = "C://Users//light1//VWphoto//after//";
        view_url = "C://Users//light1//VWphoto//view//";
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad0)) { time = 10f; }
        if (Input.GetKeyDown(KeyCode.KeypadMinus)) { time = 30f; }
